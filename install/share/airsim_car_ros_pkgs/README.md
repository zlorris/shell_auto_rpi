...
#### Publishers:
- `/airsim_node/origin_geo_point` [airsim_car_ros_pkgs/GPSYaw](msg/GPSYaw.msg)   
...
#### Subscribers: 
- `/airsim_node/vel_cmd_body_frame` [airsim_car_ros_pkgs/VelCmd](msg/VelCmd.msg)    
  Ignore `vehicle_name` field, leave it to blank. We will use `vehicle_name` in future for multiple drones.

- `/airsim_node/vel_cmd_world_frame` [airsim_car_ros_pkgs/VelCmd](msg/VelCmd.msg)    
  Ignore `vehicle_name` field, leave it to blank. We will use `vehicle_name` in future for multiple drones.

- `/gimbal_angle_euler_cmd` [airsim_car_ros_pkgs/GimbalAngleEulerCmd](msg/GimbalAngleEulerCmd.msg)   
  Gimbal set point in euler angles.    

- `/gimbal_angle_quat_cmd` [airsim_car_ros_pkgs/GimbalAngleQuatCmd](msg/GimbalAngleQuatCmd.msg)   
  Gimbal set point in quaternion.    

#### Services:
- `/airsim_node/VEHICLE_NAME/land` [airsim_car_ros_pkgs/Takeoff](https://docs.ros.org/api/std_srvs/html/srv/Empty.html)

- `/airsim_node/takeoff` [airsim_car_ros_pkgs/Takeoff](https://docs.ros.org/api/std_srvs/html/srv/Empty.html)

- `/airsim_node/reset` [airsim_car_ros_pkgs/Reset](https://docs.ros.org/api/std_srvs/html/srv/Empty.html)
 Resets *all* drones

#### Parameters:
- `/airsim_node/update_airsim_control_every_n_sec` [double]   
  Set in: `$(airsim_car_ros_pkgs)/launch/airsim_node.launch`   
...
#### Services:
- `/airsim_node/VEHICLE_NAME/gps_goal` [Request: [msgs/airsim_car_ros_pkgs/GPSYaw](msgs/airsim_car_ros_pkgs/GPSYaw)]   
  Target gps position + yaw.   
  In **absolute** altitude. 

- `/airsim_node/VEHICLE_NAME/local_position_goal` [Request: [msgs/airsim_car_ros_pkgs/XYZYaw](msgs/airsim_car_ros_pkgs/XYZYaw)   
...
#### Publishers:
- `/vel_cmd_world_frame` [airsim_car_ros_pkgs/VelCmd](airsim_car_ros_pkgs/VelCmd)   
