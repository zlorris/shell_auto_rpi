...
class LandGroupRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type LandGroupRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type LandGroupRequest
    let len;
    let data = new LandGroupRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new LandGroupRequest(null);
...
class LandGroupResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type LandGroupResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type LandGroupResponse
    let len;
    let data = new LandGroupResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'airsim_car_ros_pkgs/LandGroupResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LandGroupResponse(null);
...
module.exports = {
  Request: LandGroupRequest,
  Response: LandGroupResponse,
  md5sum() { return '1c93c56d4ef2aa094d01d2de52397e67'; },
  datatype() { return 'airsim_car_ros_pkgs/LandGroup'; }
};
