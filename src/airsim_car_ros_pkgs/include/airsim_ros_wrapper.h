...
#include <airsim_car_ros_pkgs/GimbalAngleEulerCmd.h>
#include <airsim_car_ros_pkgs/GimbalAngleQuatCmd.h>
#include <airsim_car_ros_pkgs/GPSYaw.h>
#include <airsim_car_ros_pkgs/Land.h>
#include <airsim_car_ros_pkgs/LandGroup.h>
#include <airsim_car_ros_pkgs/Reset.h>
#include <airsim_car_ros_pkgs/Takeoff.h>
#include <airsim_car_ros_pkgs/TakeoffGroup.h>
#include <airsim_car_ros_pkgs/VelCmd.h>
#include <airsim_car_ros_pkgs/VelCmdGroup.h>
...
typedef msr::airlib::CarApiBase::CarControls CarControls;
typedef msr::airlib::CarApiBase::CarState CarState;
...
private:
  ...
  void car_cmd_frame_cb(const airsim_car_ros_pkgs::CarCmd::ConstPtr& msg, const std::string& vehicle_name);
  // void set_zero_vel_cmd();

  /// ROS service callbacks
  bool reset_srv_cb(airsim_car_ros_pkgs::Reset::Request& request, airsim_car_ros_pkgs::Reset::Response& response);
  ...
  sensor_msgs::ImagePtr manual_decode_depth(const ImageResponse& img_response) const;
  ...
  {
    imu_calibration_ = params.getDouble("imu_calibration");
    speed_calibration_ = params.getDouble("speed_calibration");
  }
  ...
  nav_msgs::Odometry get_odom_msg_from_airsim_state(const CarState& drone_state) const;
  airsim_car_ros_pkgs::GPSYaw get_gps_msg_from_airsim_geo_point(const msr::airlib::GeoPoint& geo_point) const;
  sensor_msgs::NavSatFix get_gps_sensor_msg_from_airsim_geo_point(const msr::airlib::GpsBase::Output& geo_base) const;
...
private:
  ...
  struct CarROS
  {
    ...
    ros::Subscriber car_cmd_body_frame_sub;
  ...
  airsim_car_ros_pkgs::GPSYaw origin_geo_point_msg_; // todo duplicate
  ...
  bool publish_vehicle_tf_;
  bool publish_enu_;
  double imu_calibration_;
  double speed_calibration_;
