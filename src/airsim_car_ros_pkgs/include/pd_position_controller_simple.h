...
#include <airsim_car_ros_pkgs/SetLocalPosition.h>
#include <airsim_car_ros_pkgs/SetGPSPosition.h>
...
public:
    ...
    bool local_position_goal_srv_cb(airsim_car_ros_pkgs::SetLocalPosition::Request& request, airsim_car_ros_pkgs::SetLocalPosition::Response& response); 
    bool local_position_goal_srv_override_cb(airsim_car_ros_pkgs::SetLocalPosition::Request& request, airsim_car_ros_pkgs::SetLocalPosition::Response& response); 
    bool gps_goal_srv_cb(airsim_car_ros_pkgs::SetGPSPosition::Request& request, airsim_car_ros_pkgs::SetGPSPosition::Response& response);
    bool gps_goal_srv_override_cb(airsim_car_ros_pkgs::SetGPSPosition::Request& request, airsim_car_ros_pkgs::SetGPSPosition::Response& response);

    // ROS subscriber callbacks
    void airsim_odom_cb(const nav_msgs::Odometry& odom_msg);
    void home_geopoint_cb(const airsim_car_ros_pkgs::GPSYaw& gps_msg);
...
private:
    ...
    bool has_home_geo_;
    airsim_car_ros_pkgs::GPSYaw gps_home_msg_;

    nav_msgs::Odometry curr_odom_;
    airsim_car_ros_pkgs::VelCmd vel_cmd_;
    bool reached_goal_;
    bool has_goal_;
    bool has_odom_;
    bool got_goal_once_;
