...
(cl:defmethod cl:initialize-instance :after ((m <TakeoffGroup-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TakeoffGroup-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name airsim_car_ros_pkgs-srv:<TakeoffGroup-request> is deprecated: use airsim_car_ros_pkgs-srv:TakeoffGroup-request instead.")))

(cl:ensure-generic-function 'vehicle_names-val :lambda-list '(m))
(cl:defmethod vehicle_names-val ((m <TakeoffGroup-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_car_ros_pkgs-srv:vehicle_names-val is deprecated.  Use airsim_car_ros_pkgs-srv:vehicle_names instead.")
  (vehicle_names m))

(cl:ensure-generic-function 'waitOnLastTask-val :lambda-list '(m))
(cl:defmethod waitOnLastTask-val ((m <TakeoffGroup-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_car_ros_pkgs-srv:waitOnLastTask-val is deprecated.  Use airsim_car_ros_pkgs-srv:waitOnLastTask instead.")
  (waitOnLastTask m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TakeoffGroup-request>)))
  ...
  "airsim_car_ros_pkgs/TakeoffGroupRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TakeoffGroup-request)))
  "Returns string type for a service object of type 'TakeoffGroup-request"
  "airsim_car_ros_pkgs/TakeoffGroupRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <TakeoffGroup-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TakeoffGroup-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name airsim_car_ros_pkgs-srv:<TakeoffGroup-response> is deprecated: use airsim_car_ros_pkgs-srv:TakeoffGroup-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TakeoffGroup-response>)))
  ...
  "airsim_car_ros_pkgs/TakeoffGroupResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TakeoffGroup-response)))
  "Returns string type for a service object of type 'TakeoffGroup-response"
  "airsim_car_ros_pkgs/TakeoffGroupResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TakeoffGroup)))
  ...
  "airsim_car_ros_pkgs/TakeoffGroup")