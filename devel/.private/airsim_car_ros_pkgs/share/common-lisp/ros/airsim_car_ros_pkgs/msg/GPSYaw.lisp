...
(cl:defmethod cl:initialize-instance :after ((m <GPSYaw>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GPSYaw)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name airsim_car_ros_pkgs-msg:<GPSYaw> is deprecated: use airsim_car_ros_pkgs-msg:GPSYaw instead.")))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <GPSYaw>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_car_ros_pkgs-msg:latitude-val is deprecated.  Use airsim_car_ros_pkgs-msg:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <GPSYaw>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_car_ros_pkgs-msg:longitude-val is deprecated.  Use airsim_car_ros_pkgs-msg:longitude instead.")
  (longitude m))

(cl:ensure-generic-function 'altitude-val :lambda-list '(m))
(cl:defmethod altitude-val ((m <GPSYaw>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_car_ros_pkgs-msg:altitude-val is deprecated.  Use airsim_car_ros_pkgs-msg:altitude instead.")
  (altitude m))
