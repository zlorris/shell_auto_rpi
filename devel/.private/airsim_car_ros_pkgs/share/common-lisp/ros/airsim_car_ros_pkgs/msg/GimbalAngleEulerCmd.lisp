...
(cl:defmethod cl:initialize-instance :after ((m <GimbalAngleEulerCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GimbalAngleEulerCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name airsim_car_ros_pkgs-msg:<GimbalAngleEulerCmd> is deprecated: use airsim_car_ros_pkgs-msg:GimbalAngleEulerCmd instead.")))
...
(cl:defmethod camera_name-val ((m <GimbalAngleEulerCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_car_ros_pkgs-msg:camera_name-val is deprecated.  Use airsim_car_ros_pkgs-msg:camera_name instead.")
  (camera_name m))

(cl:ensure-generic-function 'vehicle_name-val :lambda-list '(m))
(cl:defmethod vehicle_name-val ((m <GimbalAngleEulerCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_car_ros_pkgs-msg:vehicle_name-val is deprecated.  Use airsim_car_ros_pkgs-msg:vehicle_name instead.")
  (vehicle_name m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <GimbalAngleEulerCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_car_ros_pkgs-msg:roll-val is deprecated.  Use airsim_car_ros_pkgs-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <GimbalAngleEulerCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_car_ros_pkgs-msg:pitch-val is deprecated.  Use airsim_car_ros_pkgs-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <GimbalAngleEulerCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_car_ros_pkgs-msg:yaw-val is deprecated.  Use airsim_car_ros_pkgs-msg:yaw instead.")
  (yaw m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GimbalAngleEulerCmd>)))
  ...
  "airsim_car_ros_pkgs/GimbalAngleEulerCmd")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GimbalAngleEulerCmd)))
  "Returns string type for a message object of type 'GimbalAngleEulerCmd"
  "airsim_car_ros_pkgs/GimbalAngleEulerCmd")
