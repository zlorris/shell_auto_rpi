...
(cl:in-package shell_simulation-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <CarCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CarCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name shell_simulation-msg:<CarCmd> is deprecated: use shell_simulation-msg:CarCmd instead.")))

(cl:ensure-generic-function 'throttle-val :lambda-list '(m))
(cl:defmethod throttle-val ((m <CarCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader shell_simulation-msg:throttle-val is deprecated.  Use shell_simulation-msg:throttle instead.")
  (throttle m))

(cl:ensure-generic-function 'steering-val :lambda-list '(m))
(cl:defmethod steering-val ((m <CarCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader shell_simulation-msg:steering-val is deprecated.  Use shell_simulation-msg:steering instead.")
  (steering m))

(cl:ensure-generic-function 'brake-val :lambda-list '(m))
(cl:defmethod brake-val ((m <CarCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader shell_simulation-msg:brake-val is deprecated.  Use shell_simulation-msg:brake instead.")
  (brake m))

(cl:ensure-generic-function 'handbrake-val :lambda-list '(m))
(cl:defmethod handbrake-val ((m <CarCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader shell_simulation-msg:handbrake-val is deprecated.  Use shell_simulation-msg:handbrake instead.")
  (handbrake m))

(cl:ensure-generic-function 'is_manual_gear-val :lambda-list '(m))
(cl:defmethod is_manual_gear-val ((m <CarCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader shell_simulation-msg:is_manual_gear-val is deprecated.  Use shell_simulation-msg:is_manual_gear instead.")
  (is_manual_gear m))

(cl:ensure-generic-function 'manual_gear-val :lambda-list '(m))
(cl:defmethod manual_gear-val ((m <CarCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader shell_simulation-msg:manual_gear-val is deprecated.  Use shell_simulation-msg:manual_gear instead.")
  (manual_gear m))

(cl:ensure-generic-function 'gear_immediate-val :lambda-list '(m))
(cl:defmethod gear_immediate-val ((m <CarCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader shell_simulation-msg:gear_immediate-val is deprecated.  Use shell_simulation-msg:gear_immediate instead.")
  (gear_immediate m))
